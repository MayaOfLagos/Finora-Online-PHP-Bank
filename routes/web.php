...
Route::middleware(['auth', 'verified.email.otp', 'verified.pin', 'user.only'])->group(function () {
    ...
    // Accounts routes - Basic account viewing (no KYC required)
    ...
    // Transaction History routes (viewing only - no KYC required)
    ...
    // Settings routes (always accessible)
    ...
    // KYC Verification (always accessible - this is the verification page itself)
    ...
    // ============================================
    // KYC PROTECTED ROUTES - Require verification
    // ============================================
    Route::middleware(['kyc.verified'])->group(function () {
        // Account management (creating/modifying accounts)
